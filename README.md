...
**🌐 [웹에서 보기](https://joongi007.github.io/awesome-shelf/)** &nbsp;·&nbsp; 📂 **322**개 항목 &nbsp;·&nbsp; 🗂️ **8**개 섹션
...
| [🤖 좋아 보이는 AI 서비스](#-좋아-보이는-ai-서비스) | 55 |
| [🧠 좋아 보이는 AI 관련 프로젝트 또는 모델](#-좋아-보이는-ai-관련-프로젝트-또는-모델) | 115 |
| [✏️ 프롬프트](#️-프롬프트) | 11 |
| [🚨 보안](#-보안) | 9 |
...
- **[liam-hq/liam](https://github.com/liam-hq/liam)** — 데이터베이스에서 읽기 쉬운 ER 다이어그램을 자동으로 생성
...
_원본 링크가 사라졌지만 나중을 위해 보관해 둔 항목 (이전처·미러 포함)_

- ~~[cloudcommunity/Free-Certifications](https://github.com/cloudcommunity/Free-Certifications)~~ — GitHub 저장소가 삭제됨(API 404)  
  ↳ [공식 커뮤니티 사이트(이전처)](https://free-certifications.com/) · [Internet Archive 스냅샷](https://web.archive.org/web/2023*/github.com/cloudcommunity/Free-Certifications)
- ~~[FareedKhan-dev/all-rag-techniques](https://github.com/FareedKhan-dev/all-rag-techniques)~~ — 저장소가 비공개 전환/삭제됨(API 404)  
  ↳ [포크 미러(98★)](https://github.com/mbergo/all-rag-techniques)
